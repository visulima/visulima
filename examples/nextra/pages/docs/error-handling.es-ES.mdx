...
## Código de estado y objeto de error [#status-code-and-error-object]
...
<Callout emoji="💡">
    Tenga en cuenta que `data` y `error` pueden existir al mismo tiempo. Por lo tanto la UI puede mostrar data existente, mientras se sabe que la próxima
