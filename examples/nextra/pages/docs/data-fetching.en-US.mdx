...
<Callout emoji="💡">
    Note that <code>fetcher</code> can be omitted from the parameters if it's <Link href="/docs/global-configuration">provided globally</Link>.
</Callout>
...
<Callout emoji="💡">
    ...
    <br />
    <a target="_blank" rel="noopener" href="https://nextjs.org/blog/next-9-1-7#new-built-in-polyfills-fetch-url-and-objectassign">
...
_If you want to pass variables to a GraphQL query, check out [Multiple OptionDefinition](/docs/arguments)._
