...
<Callout emoji="💡">
    Обратите внимание, что <code>fetcher</code> можно не указывать в параметрах, если он [предоставляется глобально](/docs/global-configuration).
</Callout>
...
<Callout emoji="💡">
    Если вы используете <strong>Next.js</strong>, вам не нужно импортировать этот полифил:
    <br />
