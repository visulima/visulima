...
import { Callout, Bleed } from "@visulima/nextra-theme-docs";

# 자동 갱신

<Callout>수동으로 데이터를 갱신하려면 [뮤테이션](/docs/mutation)을 확인하세요.</Callout>
...
`revalidateIfStale`은 마운트 시에 스태일 데이터가 존재할 경우 SWR이 갱신해야 할지 여부를 제어합니다.
