...
<Callout emoji="✅">
    С SWR, компоненты получат поток <strong>постоянно</strong> и <strong>автоматически</strong> обновляющихся данных.
    <br />И пользовательский интерфейс всегда будет <strong>быстрым</strong> и <strong>реактивным</strong>.
</Callout>

<div className="mt-16 mb-20 text-center">
    [Начать работу](/docs/getting-started) · [Примеры](/examples) · [Блог](/blog) · [Репозиторий GitHub](https://github.com/vercel/swr)
</div>
