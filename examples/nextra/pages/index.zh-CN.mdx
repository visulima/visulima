...
<Callout emoji="✅">
    使用 SWR，组件将会<strong>不断地</strong>、<strong>自动</strong>获得最新数据流。
    <br />
    UI 也会一直保持<strong>快速响应</strong>。
</Callout>

<div className="mt-16 mb-20 text-center">[入门](/docs/getting-started) · [示例](/examples) · [博客](/blog) · [GitHub 仓库](https://github.com/vercel/swr)</div>
