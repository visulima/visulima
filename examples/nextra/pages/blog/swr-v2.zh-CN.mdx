...
<Video src="/video/optimistic-ui.mp4" caption="能自动错误回滚的乐观用户 UI" ratio={223 / 584} />
...
<Callout emoji="📝">
    我们增加了新的 [理解 SWR](/docs/advanced/understanding) 页面来描述 SWR 如何返回值，其中包括 `isValidating` 和 `isLoading`
    的区别，以及如何结合它们来改善用户体验。
</Callout>
