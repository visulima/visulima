...
Example using AWS SES transport. Requires AWS SDK v2.
...
**Note**: For AWS SDK v3, use the SMTP transport with SES SMTP credentials instead.

### 5. Custom Transport (`custom-transport.ts`)
