        ...
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                <h1 className={styles.title}>
                    <a href="https://github.com/visulima/visulima/tree/main/examples/connect/pages/gssp-users/[id].tsx">getServerSideProps</a> Example
                </h1>
                <h2>User Data</h2>
...
export const getServerSideProps: GetServerSideProps<PageProps> = async ({ req, res, params }) => {
    ...
    req.params = params;
    return gsspRouter.run(req, res) as Promise<GetServerSidePropsResult<PageProps>>;
};
