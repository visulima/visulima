        ...
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                <h1 className={styles.title}>
                    <a href="https://github.com/visulima/visulima/tree/main/examples/connect/pages/api/edge-users">
                        Edge API Routes
                    </a>{" "}
                    example
                </h1>
                <p>
                    ...
                    built with @visulima/connect. Open your devtool (<code>F12</code>
                    ) and try the following snippets.
                </p>
                <h2>
