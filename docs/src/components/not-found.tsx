        ...
        <div className="py-8 px-8 md:px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div className="mx-auto max-w-screen-sm">
                        ...
                        <div className="flex flex-col items-stretch mt-4">
                            {list.map((page) => (
                                ...
                                >
                                    ...
                                    {page.icon && <div className="rounded-md bg-primary-100 px-2 py-2 md:px-3 md:py-3 lg:px-4 lg:py-4 md:py-4">{page.icon}</div>}
                ...
                <div className="flex flex-row mt-8">
                    <Anchor href="/" newWindow className="basis-2/4 text-primary-500 underline decoration-from-font [text-underline-position:under]">
                        Back to Homepage
                    </Anchor>
                    <Anchor
                        href={getGitIssueUrl({
                        ...
                        newWindow
                        className="basis-2/4 text-right text-primary-500 underline decoration-from-font [text-underline-position:under]"
                    >
