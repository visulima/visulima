...
The visulima api-platform is open-sourced software licensed under the [MIT](https://github.com/visulima/visulima/blob/main/packages/api-platform/LICENSE.md)
