...
**Universal Providers** (all runtimes): Resend, HTTP, Zeptomail  
...
**Note**: Universal providers (Resend, HTTP, Zeptomail) work in Node.js, Deno, Bun, and Cloudflare Workers without Node.js version requirements.
