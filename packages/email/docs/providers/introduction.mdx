...
- **[Plunk](/docs/package/email/providers/plunk)** - Modern email platform built on AWS SES
...
- **For Cloudflare Workers, Deno, or Bun**: Use Resend, HTTP, Zeptomail, Plunk, or Mock
- **For Node.js**: You can use any provider
- **For testing**: Use Mock provider to test email logic without sending real emails
- **For cross-runtime compatibility**: Use Resend, HTTP, Zeptomail, Plunk, or Mock, or wrap Node.js-only providers in Failover/Round Robin with universal providers as fallbacks
