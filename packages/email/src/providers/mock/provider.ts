 ...
 */
const createDefaultConfig = (): Required<Omit<MockConfig, "logger" | "defaultResponse" | "randomDelayRange">> & Pick<MockConfig, "logger" | "defaultResponse" | "randomDelayRange"> => ({
    debug: false,
    delay: 0,
    failureRate: 0,
    retries: 0,
 ...
 */
export const mockProvider: ProviderFactory<MockConfig, MockEmailEntry[], MockEmailOptions> = defineProvider(
    (options_: MockConfig = {} as MockConfig) => {
        ...
        let config: Required<Omit<MockConfig, "logger" | "defaultResponse" | "randomDelayRange">> & Pick<MockConfig, "logger" | "defaultResponse" | "randomDelayRange"> = {
            ...createDefaultConfig(),
            logger: options_.logger,
            defaultResponse: options_.defaultResponse,
            randomDelayRange: options_.randomDelayRange || { min: 0, max: 0 },
            ...options_,
        };
        ...
        return {
             ...
             */
            getSentMessages(): readonly MockEmailEntry[] {
                return [...storage];
            },
            ...
            setDelay(milliseconds: number): void {
                ...
                config.randomDelayRange = { min: 0, max: 0 };
            ...
            setRandomDelay(min: number, max: number): void {
                ...
                config.delay = 0;
                config.randomDelayRange = { min, max };
                logger.debug("Set random delay range", { min, max });
            },
             ...
             */
            findMessagesBy(predicate: (message: MockEmailEntry) => boolean): readonly MockEmailEntry[] {
             ...
             */
            getMessagesTo(email: string): readonly MockEmailEntry[] {
             ...
             */
            getMessagesBySubject(subject: string): readonly MockEmailEntry[] {
