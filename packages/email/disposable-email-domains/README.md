...
| ------------------------------------------------- | ------- | ------- | ---------------- |
| kslr/disposable-email-domains                     | 119.514 | ✅      | 1.00s (1.8 MB)   |
| disposable/disposable-email-domains               | 72.272  | ✅      | 0.39s (1.1 MB)   |
| FGRibreau/mailchecker                             | 56.048  | ✅      | 0.53s (840.7 KB) |
| wesbos/burner-email-providers                     | 27.283  | ✅      | 0.28s (388.1 KB) |
| groundcat/disposable-email-domain-list            | 27.120  | ✅      | 0.67s (401.7 KB) |
| sublime-security/static-files                     | 10.523  | ✅      | 0.23s (144.0 KB) |
| 7c/fakefilter                                     | 9.536   | ✅      | 0.19s (133.1 KB) |
| disposable-email-domains/disposable-email-domains | 5.444   | ✅      | 0.21s (69.1 KB)  |
| willwhite/freemail                                | 4.462   | ✅      | 0.22s (61.8 KB)  |
| eser/sanitizer-svc                                | 3.855   | ✅      | 0.24s (48.9 KB)  |
| unkn0w/disposable-email-domain-list               | 3.617   | ✅      | 0.41s (45.8 KB)  |
| MattKetmo/EmailChecker                            | 2.515   | ✅      | 0.54s (32.4 KB)  |
| GeroldSetz/emailondeck.com-domains                | 1.121   | ✅      | 0.23s (15.4 KB)  |
| jespernissen/disposable-maildomain-list           | 1.001   | ✅      | 0.54s (12.9 KB)  |
| castle/disposable-email-domains                   | 1.000   | ✅      | 0.28s (12.7 KB)  |
