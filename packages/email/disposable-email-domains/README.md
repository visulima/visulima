...
|------------|---------|---------|-------------|
| kslr/disposable-email-domains | 118.186 | ✅ | 0.48s (1.8 MB) |
| FGRibreau/mailchecker | 55.911 | ✅ | 0.38s (838.9 KB) |
...
| 7c/fakefilter | 9.266 | ✅ | 0.19s (130.4 KB) |
| disposable-email-domains/disposable-email-domains | 5.354 | ✅ | 0.24s (67.9 KB) |
...
| jespernissen/disposable-maildomain-list | 1.011 | ✅ | 0.15s (13.0 KB) |
| TheDahoom/disposable-email | 18 | ✅ | 0.23s (234 B) |

<!-- END_PLACEHOLDER_CONTRIBUTING -->
<!-- START_PLACEHOLDER_LAST_UPDATED -->

_Last updated: 2026-03-26T09:35:32.863Z_
