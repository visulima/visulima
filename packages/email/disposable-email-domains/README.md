...
|------------|---------|---------|-------------|
| kslr/disposable-email-domains | 117.904 | ✅ | 0.43s (1.7 MB) |
| FGRibreau/mailchecker | 55.909 | ✅ | 0.43s (838.9 KB) |
| wesbos/burner-email-providers | 27.284 | ✅ | 0.43s (388.1 KB) |
| groundcat/disposable-email-domain-list | 27.120 | ✅ | 0.21s (401.7 KB) |
| disposable/disposable-email-domains | 26.475 | ✅ | 0.30s (370.1 KB) |
| sublime-security/static-files | 10.523 | ✅ | 0.20s (144.0 KB) |
| 7c/fakefilter | 9.313 | ✅ | 0.20s (131.2 KB) |
| disposable-email-domains/disposable-email-domains | 5.204 | ✅ | 0.23s (66.0 KB) |
...
_Last updated: 2026-03-14T22:48:22.438Z_
