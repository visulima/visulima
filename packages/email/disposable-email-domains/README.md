...
|------------|---------|---------|-------------|
| willwhite/freemail | 88,162 | ✅ | 0.51s (1.3 MB) |
| disposable/disposable-email-domains | 75,419 | ✅ | 0.48s (1.1 MB) |
| FGRibreau/mailchecker | 56,331 | ✅ | 0.37s (846.3 KB) |
| wesbos/burner-email-providers | 27,277 | ✅ | 0.35s (388.0 KB) |
| sublime-security/static-files | 10,522 | ✅ | 0.29s (144.0 KB) |
| 7c/fakefilter | 10,373 | ✅ | 0.31s (143.0 KB) |
| disposable-email-domains/disposable-email-domains | 8,981 | ✅ | 0.12s (124.8 KB) |
| groundcat/disposable-email-domain-list | 5,797 | ✅ | 0.30s (80.9 KB) |
| eser/sanitizer-svc | 3,855 | ✅ | 0.61s (48.9 KB) |
| unkn0w/disposable-email-domain-list | 3,616 | ✅ | 0.29s (45.7 KB) |
| MattKetmo/EmailChecker | 2,515 | ✅ | 0.29s (32.4 KB) |
| GeroldSetz/emailondeck.com-domains | 1,121 | ✅ | 0.32s (15.4 KB) |
| castle/disposable-email-domains | 1,000 | ✅ | 0.02s (13.7 KB) |
| jespernissen/disposable-maildomain-list | 987 | ✅ | 0.30s (12.7 KB) |
| TheDahoom/disposable-email | 18 | ✅ | 0.36s (234 B) |
