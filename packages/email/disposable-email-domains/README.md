...
| ------------------------------------------------- | ------- | ------- | ---------------- |
| kslr/disposable-email-domains                     | 118.943 | ✅      | 0.43s (1.8 MB)   |
| FGRibreau/mailchecker                             | 56.048  | ✅      | 0.37s (840.8 KB) |
| wesbos/burner-email-providers                     | 27.284  | ✅      | 0.21s (388.1 KB) |
| groundcat/disposable-email-domain-list            | 27.120  | ✅      | 0.26s (401.7 KB) |
| disposable/disposable-email-domains               | 26.548  | ✅      | 0.28s (371.1 KB) |
| sublime-security/static-files                     | 10.523  | ✅      | 0.28s (144.0 KB) |
| 7c/fakefilter                                     | 9.386   | ✅      | 0.13s (131.3 KB) |
| disposable-email-domains/disposable-email-domains | 5.365   | ✅      | 0.10s (68.1 KB)  |
