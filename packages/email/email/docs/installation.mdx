...
The disposable email detection utility is included by default using `@visulima/disposable-email-domains`. The `isDisposableEmail` utility function is available to detect temporary/disposable email addresses. See [Validating Email Addresses](/docs/packages/email/getting-started/sending-mail#validating-email-addresses) for usage examples.
...
- [Getting Started](/docs/packages/email/getting-started/introduction) - Learn how to use @visulima/email
- [Configuration](/docs/packages/email/getting-started/configuration) - Configure providers for your needs
- [Sending Mail](/docs/packages/email/getting-started/sending-mail) - Send your first email
