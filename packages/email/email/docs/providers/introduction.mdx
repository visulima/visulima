...
- **[Mailgun](/docs/packages/email/providers/mailgun)** - Developer-friendly email API service ([API Docs](https://documentation.mailgun.com/en/latest/api_reference.html))
- **[Mailjet](/docs/packages/email/providers/mailjet)** - Email marketing and transactional email platform ([API Docs](https://dev.mailjet.com/email/guides/send-api-v31/))
- **[MailerSend](/docs/packages/email/providers/mailersend)** - Modern email API for developers ([API Docs](https://developers.mailersend.com/api/v1/email.html))
- **[Mandrill](/docs/packages/email/providers/mandrill)** - Mailchimp Transactional Email ([API Docs](https://mailchimp.com/developer/transactional/api/messages/send-new-message/))
- **[MailPace](/docs/packages/email/providers/mailpace)** - Simple transactional email service ([API Docs](https://docs.mailpace.com/api))
- **[Mailtrap](/docs/packages/email/providers/mailtrap)** - Email testing and development tool ([API Docs](https://mailtrap.io/api-docs))
- **[Postal](/docs/packages/email/providers/postal)** - Self-hosted email server ([API Docs](https://postal.atech.media/docs/developer/sending))
- **[Postmark](/docs/packages/email/providers/postmark)** - Transactional email service focused on deliverability ([API Docs](https://postmarkapp.com/developer/api/email-api))
- **[Azure](/docs/packages/email/providers/azure)** - Microsoft Azure Communication Services ([API Docs](https://learn.microsoft.com/en-us/azure/communication-services/concepts/email/email-overview))
- **[Infobip](/docs/packages/email/providers/infobip)** - Global communication platform ([API Docs](https://www.infobip.com/docs/api/channels/email/send-email))
- **[Scaleway](/docs/packages/email/providers/scaleway)** - European cloud provider email service ([API Docs](https://www.scaleway.com/en/docs/messaging-and-queuing/transactional-email/api-reference/))
- **[AhaSend](/docs/packages/email/providers/ahasend)** - Email delivery service ([API Docs](https://api.ahasend.com/docs))
- **[Mailomat](/docs/packages/email/providers/mailomat)** - Email service provider ([API Docs](https://api.mailomat.com/docs))
- **[Sweego](/docs/packages/email/providers/sweego)** - Email delivery service ([API Docs](https://api.sweego.com/docs))
- **[SendGrid](/docs/packages/email/providers/sendgrid)** - Cloud-based email service for transactional and marketing emails ([API Docs](https://docs.sendgrid.com/api-reference/mail-send/mail-send))
- **[SMTP](/docs/packages/email/providers/smtp)** - Standard SMTP protocol ([RFC 5321](https://tools.ietf.org/html/rfc5321))
- **[Zeptomail](/docs/packages/email/providers/zeptomail)** - Zeptomail email service ([API Docs](https://www.zeptomail.com/docs/api/))
- **[Plunk](/docs/packages/email/providers/plunk)** - Modern email platform built on AWS SES ([API Docs](https://docs.useplunk.com/api-reference))
- **[HTTP](/docs/packages/email/providers/http)** - Generic HTTP API provider
- **[Nodemailer](/docs/packages/email/providers/nodemailer)** - Popular Node.js email library wrapper ([API Docs](https://nodemailer.com/about/))
- **[Mock](/docs/packages/email/providers/mock)** - In-memory provider for testing
- **[Failover](/docs/packages/email/providers/failover)** - Automatic failover between multiple providers
- **[Round Robin](/docs/packages/email/providers/roundrobin)** - Load balancing across multiple providers
- **[MailCrab](/docs/packages/email/providers/mailcrab)** - Local development email testing ([Docs](https://mailcrab.app/))
- **[OpenTelemetry](/docs/packages/email/providers/opentelemetry)** - OpenTelemetry instrumentation wrapper for observability ([API Docs](https://opentelemetry.io/docs/))
...
- ✅ **AutoSend** - Uses Fetch API, works everywhere
...
- [Configuration](/docs/packages/email/getting-started/configuration) - Learn how to configure providers
