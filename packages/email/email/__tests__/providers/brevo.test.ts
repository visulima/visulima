...
describe(brevoProvider, () => {
    ...
    describe("branch coverage", () => {
        it("should send a text-only email with logger, templateId without params, a string scheduledAt, and a generated message id", async () => {
            expect.assertions(1);
            ...
            const provider = brevoProvider({ apiKey: "test123", logger });
