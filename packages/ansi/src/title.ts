 ...
 * ```
 */
export const setIconName = (iconName: string): string => {
    return `${OSC}1;${iconName}${BEL}`;
};
 ...
 * ```
 */
export const setWindowTitle = (title: string): string => {
 ...
 * ```
 */
export const decswt = (name: string): string => {
 ...
 * ```
 */
export const decsin = (name: string): string => {
 ...
 * ```
 */
export const setIconNameAndWindowTitleWithST = (title: string): string => {
 ...
 * ```
 */
export const setIconNameWithST = (iconName: string): string => {
    return `${OSC}1;${iconName}${ST}`;
};
 ...
 * ```
 */
export const setWindowTitleWithST = (title: string): string => {
