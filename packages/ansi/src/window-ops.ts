 ...
 * ```
 */
export const resizeTextAreaChars = (height: number, width: number): string => {
    return xtermWindowOp(XTermWindowOp.RESIZE_TEXT_AREA_CHARS, height, width);
};
 ...
 * ```
 */
export const requestTextAreaSizeChars = (): string => {
    return xtermWindowOp(XTermWindowOp.REQUEST_WINDOW_SIZE_WIN_OP_COMPAT); // This is 14, same as REPORT_TEXT_AREA_SIZE_CHARS
};
 ...
 * ```
 */
export const requestCellSizePixels = (): string => {
    return xtermWindowOp(XTermWindowOp.REPORT_CELL_SIZE_PIXELS);
};
 ...
 * ```
 */
export const requestTextAreaSizePixels = (): string => {
    return xtermWindowOp(XTermWindowOp.REPORT_TEXT_AREA_SIZE_PIXELS);
};
 ...
 * ```
 */
export const deiconifyWindow = (): string => {
    return xtermWindowOp(XTermWindowOp.DEICONIFY_WINDOW);
};
 ...
 * ```
 */
export const iconifyWindow = (): string => {
    return xtermWindowOp(XTermWindowOp.ICONIFY_WINDOW);
};
 ...
 * ```
 */
export const moveWindow = (x: number, y: number): string => {
    return xtermWindowOp(XTermWindowOp.MOVE_WINDOW, x, y);
};
 ...
 * ```
 */
export const raiseWindow = (): string => {
    return xtermWindowOp(XTermWindowOp.RAISE_WINDOW);
};
 ...
 * ```
 */
export const lowerWindow = (): string => {
    return xtermWindowOp(XTermWindowOp.LOWER_WINDOW);
};
 ...
 * ```
 */
export const refreshWindow = (): string => {
    return xtermWindowOp(XTermWindowOp.REFRESH_WINDOW);
};
 ...
 * ```
 */
export const resizeTextAreaPixels = (height: number, width: number): string => {
    return xtermWindowOp(XTermWindowOp.RESIZE_TEXT_AREA_PIXELS, height, width);
};
 ...
 * ```
 */
export const restoreMaximizedWindow = (): string => {
    return xtermWindowOp(XTermWindowOp.RESTORE_MAXIMIZED_WINDOW);
};
 ...
 * ```
 */
export const maximizeWindow = (): string => {
    return xtermWindowOp(XTermWindowOp.MAXIMIZE_WINDOW);
};
