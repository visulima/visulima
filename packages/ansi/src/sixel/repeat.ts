...
return null;
    ...
    let countString = "";
    // const initialPosAfterBang = pos; // Not strictly needed with current logic path
    while (pos < sixelData.length && sixelData[pos] >= "0" && sixelData[pos] <= "9") {
