...
<Tabs items={["pnpm", "npm", "yarn"]}>
    <Tab value="pnpm">```bash pnpm add @visulima/string ```</Tab>
    <Tab value="npm">```bash npm install @visulima/string ```</Tab>
    <Tab value="yarn">```bash yarn add @visulima/string ```</Tab>
</Tabs>
...
```typescript
// Case conversion (most per-file modules use default exports)
import camelCase from "@visulima/string/case/camel-case";
import pascalCase from "@visulima/string/case/pascal-case";
// A few use named exports (kebab-case, flip-case, split-by-case)
