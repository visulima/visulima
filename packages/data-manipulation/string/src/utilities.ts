...
// prettier-ignore
const RE_CHINESE = /[\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u3005\u3007\u3021-\u3029\u3038-\u303B\u3400-\u4DBF\u4E00-\u9FFC\uF900-\uFA6D\uFA70-\uFAD9]|\uD81B[\uDFF0\uDFF1]|[\uD840-\uD868\uD86A-\uD86C\uD86F-\uD872\uD874-\uD879\uD880-\uD883][\uDC00-\uDFFF]|\uD869[\uDC00-\uDEDD\uDF00-\uDFFF]|\uD86D[\uDC00-\uDF34\uDF40-\uDFFF]|\uD86E[\uDC00-\uDC1D\uDC20-\uDFFF]|\uD873[\uDC00-\uDEA1\uDEB0-\uDFFF]|\uD87A[\uDC00-\uDFE0]|\uD87E[\uDC00-\uDE1D]|\uD884[\uDC00-\uDF4A]/;

const RE_PUNCTUATION_OR_SPACE = /[\p{P}\p{Z}]/u;
...
export const escapeRegExp = (char: string): string =>
    ...
    char.replaceAll(RE_REGEXP_SPECIAL, String.raw`\$&`);
 ...
 */
export const hasChinese = (char: string): boolean => RE_CHINESE.test(char);
 ...
 */
export const hasPunctuationOrSpace = (char: string): boolean => RE_PUNCTUATION_OR_SPACE.test(char);
