...
export const underlineCurly: ColorizeType = colorize.underlineCurly;
export const underlineDashed: ColorizeType = colorize.underlineDashed;
export const underlineDotted: ColorizeType = colorize.underlineDotted;
export const underlineDouble: ColorizeType = colorize.underlineDouble;
