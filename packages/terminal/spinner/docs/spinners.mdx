...
description: Complete reference of all 101 available spinners
sidebar_position: 4
---

All 101 spinners with their names, frame counts, and animation speed. Use any name in the `spinner` option.
