---
title: Components
description: "Reference for all React components in @visulima/tui: Box, Text, BigText, Gradient, Link, Cursor, Newline, Spacer, Static, Transform, Spinner, ProgressBar"
---
...
import { BigText, Gradient, ProgressBar, Spinner } from "@visulima/tui/ink";
```
