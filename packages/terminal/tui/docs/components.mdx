---
title: Components
description: "Reference for all React components in @visulima/tui: Alert, Badge, Box, Code, Text, BigText, ConfirmInput, DiffView, Gradient, Link, Markdown, MultiSelect, Newline, OrderedList, Slider, Spacer, Static, StatusMessage, Tab, Tabs, Textarea, TextInput, Transform, Spinner, ProgressBar, SelectInput, Table, UnorderedList"
---
