---
title: Components
description: "Reference for all React components in @visulima/tui: Alert, Badge, Box, Text, BigText, ConfirmInput, Gradient, Link, MultiSelect, Newline, OrderedList, Slider, Spacer, Static, StatusMessage, Tab, Tabs, Textarea, TextInput, Transform, Spinner, ProgressBar, SelectInput, Table, UnorderedList"
---
