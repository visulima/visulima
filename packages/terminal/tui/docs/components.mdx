---
title: Components
description: "Reference for all React components in @visulima/tui: Box, Text, BigText, Gradient, Link, Cursor, Newline, Spacer, Static, Transform, Spinner, ProgressBar, SelectInput, Table"
---
...
import { BigText, Gradient, ProgressBar, SelectInput, Spinner, Table } from "@visulima/tui/ink";
```
