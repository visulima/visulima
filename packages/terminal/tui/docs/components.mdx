---
title: Components
description: "Reference for all React components in @visulima/tui: Box, Text, BigText, ConfirmInput, Gradient, Link, MultiSelect, Newline, Spacer, Static, TextInput, Transform, Spinner, ProgressBar, SelectInput, Table"
---
