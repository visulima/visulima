---
title: Hooks
description: "Reference for all React hooks in @visulima/tui/react: useInput, usePaste, useClipboard, useTextBuffer, useTextSelection, useMouse, useTextInput, useCursor, useScrollable, useFocus, useApp, and more"
---
