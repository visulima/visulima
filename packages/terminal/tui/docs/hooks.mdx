---
title: Hooks
description: "Reference for all React hooks in @visulima/tui/react: useInput, usePaste, useMouse, useTextInput, useScrollable, useFocus, useApp, and more"
---
...
```tsx
import { useApp, useFocus, useFocusManager, useInput, useMouse, usePaste, useScrollable, useTextInput } from "@visulima/tui/react";
```
