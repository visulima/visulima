/* eslint-disable @typescript-eslint/no-non-null-assertion, @typescript-eslint/no-unsafe-argument, @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-member-access, @typescript-eslint/prefer-nullish-coalescing, @typescript-eslint/restrict-template-expressions, import/exports-last, promise/always-return */
...
const LANGUAGE_IMPORT_MAP: Record<string, () => Promise<LanguageInput>> = {
    bash: () => import("@shikijs/langs/bash") as Promise<LanguageInput>,
    c: () => import("@shikijs/langs/c") as Promise<LanguageInput>,
    clojure: () => import("@shikijs/langs/clojure") as Promise<LanguageInput>,
    cpp: () => import("@shikijs/langs/cpp") as Promise<LanguageInput>,
    csharp: () => import("@shikijs/langs/csharp") as Promise<LanguageInput>,
    css: () => import("@shikijs/langs/css") as Promise<LanguageInput>,
    dart: () => import("@shikijs/langs/dart") as Promise<LanguageInput>,
    diff: () => import("@shikijs/langs/diff") as Promise<LanguageInput>,
    dockerfile: () => import("@shikijs/langs/dockerfile") as Promise<LanguageInput>,
    elixir: () => import("@shikijs/langs/elixir") as Promise<LanguageInput>,
    erlang: () => import("@shikijs/langs/erlang") as Promise<LanguageInput>,
    go: () => import("@shikijs/langs/go") as Promise<LanguageInput>,
    graphql: () => import("@shikijs/langs/graphql") as Promise<LanguageInput>,
    groovy: () => import("@shikijs/langs/groovy") as Promise<LanguageInput>,
    haskell: () => import("@shikijs/langs/haskell") as Promise<LanguageInput>,
    html: () => import("@shikijs/langs/html") as Promise<LanguageInput>,
    java: () => import("@shikijs/langs/java") as Promise<LanguageInput>,
    javascript: () => import("@shikijs/langs/javascript") as Promise<LanguageInput>,
    json: () => import("@shikijs/langs/json") as Promise<LanguageInput>,
    jsonc: () => import("@shikijs/langs/jsonc") as Promise<LanguageInput>,
    jsx: () => import("@shikijs/langs/jsx") as Promise<LanguageInput>,
    kotlin: () => import("@shikijs/langs/kotlin") as Promise<LanguageInput>,
    less: () => import("@shikijs/langs/less") as Promise<LanguageInput>,
    lua: () => import("@shikijs/langs/lua") as Promise<LanguageInput>,
    makefile: () => import("@shikijs/langs/makefile") as Promise<LanguageInput>,
    markdown: () => import("@shikijs/langs/markdown") as Promise<LanguageInput>,
    mdx: () => import("@shikijs/langs/mdx") as Promise<LanguageInput>,
    nginx: () => import("@shikijs/langs/nginx") as Promise<LanguageInput>,
    objc: () => import("@shikijs/langs/objc") as Promise<LanguageInput>,
    perl: () => import("@shikijs/langs/perl") as Promise<LanguageInput>,
    php: () => import("@shikijs/langs/php") as Promise<LanguageInput>,
    powershell: () => import("@shikijs/langs/powershell") as Promise<LanguageInput>,
    prisma: () => import("@shikijs/langs/prisma") as Promise<LanguageInput>,
    python: () => import("@shikijs/langs/python") as Promise<LanguageInput>,
    r: () => import("@shikijs/langs/r") as Promise<LanguageInput>,
    ruby: () => import("@shikijs/langs/ruby") as Promise<LanguageInput>,
    rust: () => import("@shikijs/langs/rust") as Promise<LanguageInput>,
    scala: () => import("@shikijs/langs/scala") as Promise<LanguageInput>,
    scss: () => import("@shikijs/langs/scss") as Promise<LanguageInput>,
    shell: () => import("@shikijs/langs/shell") as Promise<LanguageInput>,
    sql: () => import("@shikijs/langs/sql") as Promise<LanguageInput>,
    svelte: () => import("@shikijs/langs/svelte") as Promise<LanguageInput>,
    swift: () => import("@shikijs/langs/swift") as Promise<LanguageInput>,
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    text: () => Promise.resolve({ name: "text", patterns: [], repository: {}, scopeName: "source.text" } as any as LanguageInput),
    toml: () => import("@shikijs/langs/toml") as Promise<LanguageInput>,
    tsx: () => import("@shikijs/langs/tsx") as Promise<LanguageInput>,
    typescript: () => import("@shikijs/langs/typescript") as Promise<LanguageInput>,
    vue: () => import("@shikijs/langs/vue") as Promise<LanguageInput>,
    xml: () => import("@shikijs/langs/xml") as Promise<LanguageInput>,
    yaml: () => import("@shikijs/langs/yaml") as Promise<LanguageInput>,
    zig: () => import("@shikijs/langs/zig") as Promise<LanguageInput>,
};
