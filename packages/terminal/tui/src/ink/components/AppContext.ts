/* eslint-disable @stylistic/no-tabs, @stylistic/no-trailing-spaces, @typescript-eslint/no-redundant-type-constituents, @typescript-eslint/no-unnecessary-type-arguments, jsdoc/check-alignment, jsdoc/require-asterisk-prefix, sonarjs/no-tab, unicorn/filename-case */
