...
export type { CanvasColor, CanvasContext, CellStyle, Props as CanvasProps } from "./components/canvas";
...
export type { Props as MenuProps, MenuItem, MenuSection } from "./components/menu";
...
export type { Props as TooltipProps, TooltipPlacement } from "./components/tooltip";
