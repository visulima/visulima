...
const findControlStringTerminatorIndex = (text: string, fromIndex: number, allowBellTerminator: boolean): number | undefined => {
...
const malformedFromIndex = (tokens: AnsiToken[], text: string, textStartIndex: number, fromIndex: number): AnsiToken[] => {
