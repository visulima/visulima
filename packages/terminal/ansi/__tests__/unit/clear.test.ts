...
describe("clear utilities", () => {
    describe(clearScreenFromTopLeft, () => {
        it("should be the combination of cursorTo(0,0) and eraseDisplay(ToEnd)", () => {
            expect.assertions(1);
    ...
    describe(clearLineAndHomeCursor, () => {
        it("should be the combination of eraseLine(EntireLine) and cursorToColumn(0)", () => {
            expect.assertions(1);
    ...
    describe(clearScreenAndHomeCursor, () => {
        it("should be the combination of cursorTo(0,0) and eraseDisplay(EntireScreen)", () => {
            expect.assertions(1);
    ...
    describe(resetTerminal, () => {
        it.runIf(!isWindows)("should produce correct sequence when isWindows is false", () => {
            expect.assertions(1);

            expect(resetTerminal).toBe(`${CSI}2J${CSI}3J${CSI}H${ESC}c`);
        });

        it.runIf(isWindows)("should produce correct sequence when isWindows is true", () => {
            expect.assertions(1);
