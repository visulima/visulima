...
describe(`cursor`, () => {
    it.each([
        ...
        ["cursorMove (negative x)", cursorMove, [-3, 0], "\u001B[3D"],
        ["cursorMove (negative y)", cursorMove, [0, -2], "\u001B[2A"],
        ["cursorMove (negative x and y)", cursorMove, [-3, -2], "\u001B[3D\u001B[2A"],
        ["cursorMove (no movement)", cursorMove, [0, 0], ""],
        ...
        ["cursorPosition (row 5, col 10)", cursorPosition, [5, 10], "\u001B[5;10H"],
