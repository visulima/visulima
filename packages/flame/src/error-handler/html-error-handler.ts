...
import { addStatusCodeToResponse } from "./utils";
import type { TemplateOptions } from "../error-inspector/types";

export type HtmlErrorHandlerOptions = TemplateOptions & {
    // Debug mode for error-inspector display:
    // - true: always show error-inspector
    // - false: never show error-inspector
    // - "auto" (default): show when NODE_ENV !== "production"
    debug?: boolean | "auto";
