...
const shortcutsButton = (): string => {
  ...
  <div class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition-opacity inline-block absolute invisible z-20 w-80 md:w-96 p-4 bg-[var(--flame-surface)] border border-[var(--flame-border)] text-sm text-[var(--flame-text-muted)] rounded-[var(--flame-radius-lg)] shadow-[var(--flame-elevation-2)] dark:bg-[var(--flame-surface)] dark:border-[var(--flame-border)]" role="tooltip">
    <div class="flex items-center justify-between mb-3">
      <div class="flex items-center gap-2">
        ...
        <h3 class="font-semibold text-gray-800 dark:text-white text-sm">Keyboard shortcuts</h3>
      </div>
    ...
    <ul class="grid grid-cols-1 gap-2">
      <li class="flex items-start justify-between gap-3">
        <span class="text-xs text-gray-800 dark:text-gray-200">Move focus</span>
      ...
      <li class="flex items-start justify-between gap-3">
        <span class="text-xs text-gray-800 dark:text-gray-200">Activate controls</span>
        <div class="flex items-center gap-1 shrink-0">
          <kbd>Enter</kbd>
          <span class="text-[11px] text-gray-400">or</span>
          <kbd>Space</kbd>
      ...
      <li class="flex items-start justify-between gap-3">
        <span class="text-xs text-gray-800 dark:text-gray-200">Open this help</span>
        <div class="flex items-center gap-1 shrink-0">
          <kbd>Shift</kbd>
          <kbd>/</kbd>
      ...
      <li class="flex items-start justify-between gap-3">
        <span class="text-xs text-gray-800 dark:text-gray-200">Close dialogs</span>
        <div class="flex items-center gap-1 shrink-0">
          <kbd>Esc</kbd>
        </div>
      </li>
