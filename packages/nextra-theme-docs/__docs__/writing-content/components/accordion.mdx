...
<Accordion title="I am an Accordion.">
    You can put any content in here. Check out [AccordionGroup](/docs/nextra-theme-docs/writing-content/components/accordion-group)
    if you want to group multiple Accordions into a single display.
</Accordion>
