...
import { Callout, FileTree } from "@visulima/nextra-theme-docs/components";
import menuImage from "@public/assets/nextra-theme-docs/menu.png";

<Callout>Read more about Nextra's `_meta.json` files [here](https://nextra.site/docs/guide/organize-files).</Callout>
...
<Callout>
    If any routes are not listed in the `_meta.json` file, they will be appended to the end of the sidebar and sorted alphabetically, and the title will be
...
<Video src="/assets/nextra-theme-docs/sub-docs.mp4" />
...
<ImageFrame src={menuImage} alt="Navbar menu" />

<div className="mt-8 text-center text-sm">
    [Live example on StackBlitz ↗](https://stackblitz.com/edit/nextra-2-docs-2qopvp?file=pages%2F_meta.json)
    <span className="sr-only"> (opens in a new tab)</span>
</div>
...
<Callout>
    Together with the [`sidebar.titleComponent`](/docs/docs-theme/theme-configuration#sidebar) theme option, you can customize the look of titles and separator
...
<div className="mt-4 text-center text-sm">
    [Live example on StackBlitz ↗](https://stackblitz.com/edit/nextra-2-docs-hg77h3?file=pages%2F_meta.json,pages%2Findex.mdx)
    <span className="sr-only"> (opens in a new tab)</span>
</div>
