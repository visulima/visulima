...
<OptionTable options={[["useNextSeoProps", "() => NextSeoProps", "A React hook function that returns options for Next SEO."]]} />

For example, we can have all pages rendering the same suffix for `<title>`:

import titleSuffixImage from "@public/assets/nextra-theme-docs/title-suffix.png";

<ImageFrame src={titleSuffixImage} alt="Title suffix" />
...
export default {
    head: (
        <>
            ...
            <meta content="Nextra" property="og:title" />
            <meta content="The next site builder" property="og:description" />
        </>
    ),
};
```
    ...
    head: () => {
        ...
        return (
            <>
                ...
                <meta content={frontMatter.title || "Nextra"} property="og:title" />
                <meta content={frontMatter.description || "The next site builder"} property="og:description" />
            </>
        );
    },
};
...
<OptionTable options={[["primaryHue", "number | { dark: number; light: number }", "The hue of the primary theme color."]]} />
...
<div className="mt-4 flex h-6 items-center gap-2">
    <input
        ...
        onChange={(event) => {
            ...
            document.querySelector("#test-theme-hue").textContent = hue;
        }}
    />
...
import logoImage from "@public/assets/nextra-theme-docs/logo.png";

<ImageFrame src={logoImage} alt="Customized Logo" />
...
export default {
    logo: (
        <>
            ...
            <span style={{ fontWeight: 800, marginLeft: ".4em" }}>My Cool Project</span>
        </>
    ),
};
```
...
import projectLinkImage from "@public/assets/nextra-theme-docs/project-link.png";

<ImageFrame src={projectLinkImage} alt="Project link" full />
...
export default {
    chat: {
        icon: (
            <svg height="24" viewBox="0 0 248 204" width="24">
                <path
...
Show a dismissible banner on the top of the website. It can be used to show a
warning or a notice.
...
import bannerImage from "@public/assets/nextra-theme-docs/banner.png";

<ImageFrame src={bannerImage} alt="Banner" />
...
export default {
    banner: {
        key: "2.0-release",
        text: (
            <a href="https://nextra.site" rel="noreferrer" target="_blank">
...
import sidebarTitleComponentImage from "@public/assets/nextra-theme-docs/sidebar-customized.png";

<ImageFrame src={sidebarTitleComponentImage} alt="Customized Sidebar" />
...
import navigationImage from "@public/assets/nextra-theme-docs/navigation.png";

<ImageFrame src={navigationImage} alt="Navigation" full />
...
<OptionTable options={[["gitTimestamp", "React.ReactNode | React.FC<{ timestamp: Date }>", "Component to render the last updated info."]]} />
...
<OptionTable
    options={[
        ["themeSwitch.component", "React.ReactNode | React.FC<{ lite?: boolean, className?: string }>", "Component to render the theme switch."],
...
<OptionTable options={[["faviconGlyph", `string`, "The glyph to use as the favicon."]]} />
