...
const GoIcon: FC<SVGAttributes<SVGElement>> = (properties = {}) => (
    ...
    <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" {...properties}>
        ...
        />
        <path clipPath="url(#go-original-b)" clipRule="evenodd" d="M21.1 68.7c.5-.2 1.1-.3 1.4-.8" fill="#C6B198" fillRule="evenodd" />
        <path
            clipPath="url(#go-original-b)"
            d="M21.1 69c-.1 0-.3-.1-.3-.2-.1-.2 0-.4.2-.4.1 0 .2-.1.2-.1.4-.2.8-.3 1-.6.1-.1.3-.2.5-.1.1.1.2.3.1.5-.4.5-.9.7-1.3.8l-.2.1h-.2z"
        />
        <path clipPath="url(#go-original-b)" clipRule="evenodd" d="M29.3 26.4c-13.6-3.8-3.5-21.1 7.4-14l-7.4 14z" fill="#6AD7E5" fillRule="evenodd" />
        <path
            clipPath="url(#go-original-b)"
        ...
        />
        <path clipPath="url(#go-original-b)" clipRule="evenodd" d="M89.6 11.1c10.7-7.5 20.5 9.5 8 13.8l-8-13.8z" fill="#6AD7E5" fillRule="evenodd" />
        <path
            clipPath="url(#go-original-b)"
        ...
        />
        <path clipPath="url(#go-original-b)" clipRule="evenodd" d="M107.1 68.2c-.5-.2-1.1-.3-1.4-.8" fill="#C6B198" fillRule="evenodd" />
        <path
            clipPath="url(#go-original-b)"
        ...
        <path
            ...
            fill="#231F20"
        />
        <path clipPath="url(#go-original-b)" clipRule="evenodd" d="M58.6 32.1c-.2-4.7 8.8-5.3 9.8-1.4 1.1 4-9.4 4.9-9.8 1.4" fillRule="evenodd" />
    </svg>
);
