...
<Tabs items={["pnpm", "npm", "yarn"]}>
    <Tab>```bash pnpm i next react react-dom nextra @visulima/nextra-theme-docs ```</Tab>
    <Tab>```bash npm i next react react-dom nextra @visulima/nextra-theme-docs ```</Tab>
    <Tab>```bash yarn add next react react-dom nextra @visulima/nextra-theme-docs ```</Tab>
</Tabs>
