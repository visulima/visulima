 ...
 */
export const FIND_UP_STOP: symbol = Symbol("findUpStop");
 ...
 * // Result: { "key": "value" }
 */
export const INTERNAL_STRIP_JSON_REGEX: RegExp = /"(?:[^"\\]|\\.)*"|\/\/[^\r\n]*|\/\*[\s\S]*?\*\//g;
