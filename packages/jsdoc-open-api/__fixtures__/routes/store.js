 ...
 * @security ApiKey
 */
router.get("/inventory", async (request, res, next) => {
    res.end();
});
 ...
 */
router.get("/order/:orderId", async (request, res, next) => {
    res.end();
});
 ...
 * @response 404 - Order not found
 */
router.delete("/order/:orderId", async (request, res, next) => {
    res.end();
});
 ...
 */
router.post("/order", async (request, res, next) => {
    res.end();
});
