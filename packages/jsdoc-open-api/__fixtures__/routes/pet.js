 ...
 * @security PetstoreAuth.read:pets
 */
router.put("/", async (request, res, next) => {
    res.end();
});
 ...
 * @security PetstoreAuth.read:pets
 */
router.get("/findByStatus", async (request, res, next) => {
    res.end();
});
 ...
 * @security PetstoreAuth.read:pets
 */
router.get("/findByTags", async (request, res, next) => {
    res.end();
});
 ...
 * @security PetstoreAuth.read:pets
 */
router.post("/:petId", async (request, res, next) => {
    res.end();
});
 ...
 * @security PetstoreAuth.read:pets
 */
router.delete("/:petId", async (request, res, next) => {
    res.end();
});
 ...
 * @security PetstoreAuth.read:pets
 */
router.post("/:petId/uploadImage", async (request, res, next) => {
    res.end();
});
