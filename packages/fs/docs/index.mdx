...
import { FileIcon, BookOpenIcon, CodeIcon, ShieldCheckIcon } from 'lucide-react';
...
<Callout type="info">
The package is organized into several submodules that can be imported separately for better tree-shaking.
</Callout>
...
<Cards>
  ...
  <Card
    ...
    href="https://www.npmjs.com/package/@visulima/fs"
  />
</Cards>
