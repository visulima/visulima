 ...
 * @response default - successful operation
 */
router.post("/createWithArray", async (request, res, next) => {
    res.end();
});
 ...
 * @response default - successful operation
 */
router.post("/createWithList", async (request, res, next) => {
    res.end();
});
 ...
 */
router.get("/:username", async (request, res, next) => {
    res.end();
});
 ...
 * @response 404 - User not found
 */
router.put("/:username", async (request, res, next) => {
    res.end();
});
 ...
 * @response 404 - User not found
 */
router.delete("/:username", async (request, res, next) => {
    res.end();
});
 ...
 */
router.get("/login", async (request, res, next) => {
    res.end();
});
 ...
 * @response default - successful operation
 */
router.get("/logout", async (request, res, next) => {
    res.end();
});
