import { Tab, Tabs, Callout } from "@visulima/nextra-theme-docs/components";

This guide covers how to install and set up Colorize in your project.
...
The browser version requires using the spread operator. See the [Browser Usage](/docs/package/colorize/browser) guide for details.
</Callout>
...
See [Environment Variables & CLI](/docs/package/colorize/cli-environment) for more details.
