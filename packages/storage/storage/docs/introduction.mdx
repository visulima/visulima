...
- [Files facade reference](./files-facade.mdx) — full surface (single + bulk, hooks, ranges, progress, `transfer`).
...
- [Retry mechanism](./retry-mechanism.mdx) — backoff, custom `shouldRetry`, `onRetry` hook.
