...
export const streamChecksum = (checksum: string, algorithm: string, encoding: BinaryToTextEncoding = "base64"): PassThrough | StreamChecksum => algorithm ? new StreamChecksum(checksum, algorithm, encoding) : new PassThrough()
