...
- **🖼️ On-demand image transformations** - Transform images via URL query parameters
...
Visulima upload provides multiple API methods for different environments:
...
```ts
import { DiskStorage, ImageTransformer } from "@visulima/upload";
