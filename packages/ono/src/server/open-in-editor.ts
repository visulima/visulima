 ...
 */
export const createOpenInEditorMiddleware = (options: OpenInEditorOptions = {}) => async function universalHandler(request: IncomingMessage & { body?: any }, response: ServerResponse, next?: (error?: any) => void) {
    try {
