...
<details>
<summary>**ErrorPageParams**</summary>
...
```ts tab="Basic" title="basic-handler.ts"
...
```ts tab="With Options" title="with-options.ts"
const handler = await httpHandler(error, {
    showTrace: process.env.NODE_ENV !== "production",
    cspNonce: "abc123",
...
```ts tab="Custom Handlers" title="custom-handlers.ts"
const handler = await httpHandler(error, {
    extraHandlers: [
        {
...
<details>
<summary>**FetchErrorPageParams**</summary>
...
<details>
<summary>**FetchErrorHandlers**</summary>
...
```ts tab="Basic" title="cli-basic.ts"
try {
...
```ts tab="With Colors" title="cli-colors.ts"
await cliHandler(error as Error, {
...
```ts tab="Short Paths" title="cli-short-paths.ts"
await cliHandler(error as Error, {
    displayShortPath: true,
    frameContextLines: 5,
});
...
```ts title="negotiated-handler.ts"
