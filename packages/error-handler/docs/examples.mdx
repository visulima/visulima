...
```ts tab="Custom Serialization" title="server-custom.ts"
import Fastify from "fastify";
import httpHandler from "@visulima/error-handler/handler/http/node";
...
```ts tab="Basic Server" title="server.ts"
...
```ts tab="With Router" title="server-router.ts"
import { createServer } from "node:http";
import httpHandler from "@visulima/error-handler/handler/http/node";
...
```ts tab="With Middleware" title="app-middleware.ts"
import { Hono } from "hono";
...
```ts tab="With KV" title="worker-kv.ts"
import fetchHandler from "@visulima/error-handler/handler/http/cloudflare";
...
> **Warning**: Always use `showTrace: false` in Cloudflare Workers to prevent exposing sensitive information.
...
```ts tab="With File System" title="server-fs.ts"
import fetchHandler from "@visulima/error-handler/handler/http/deno";
...
```ts tab="Custom Colors" title="cli-colors.ts"
import { cliHandler } from "@visulima/error-handler/handler/cli";
...
```ts tab="With Hints" title="cli-hints.ts"
import { cliHandler } from "@visulima/error-handler/handler/cli";
...
<details>
<summary>**Custom YAML Handler**</summary>

```ts title="yaml-handler.ts"
import httpHandler from "@visulima/error-handler/handler/http/node";
...
<details>
<summary>**CSP Nonce Support**</summary>
...
<details>
<summary>**Error Tracking Integration**</summary>

```ts title="sentry-integration.ts"
import httpHandler from "@visulima/error-handler/handler/http/node";
...
<details>
<summary>**Custom Error Page with Template**</summary>

```ts title="template-error-page.ts"
import httpHandler from "@visulima/error-handler/handler/http/node";
...
<details>
<summary>**Async Error Page Generation**</summary>

```ts title="async-error-page.ts"
import httpHandler from "@visulima/error-handler/handler/http/node";
