...
<Callout type="warn">
If border characters appear as question marks or boxes, your terminal may not support Unicode.
</Callout>
...
<Callout type="warn">
Colors require terminal support for ANSI escape codes. Some terminals may not support colors.
</Callout>
...
1. **Check the Examples**: Review the [examples](./examples) for similar use cases
2. **Read the API Docs**: Consult the [Table API](./api/table) and [Grid API](./api/grid) for detailed information
...
- [Table API](./api/table) - Table API documentation
- [Grid API](./api/grid) - Grid API documentation
