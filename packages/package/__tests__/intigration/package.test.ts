...
describe("usage `@visulima/package` npm package", () => {
    it(`should work as CommonJS package`, () => {
        ...
        const filename = join(dirname(fileURLToPath(import.meta.url)), "../..", "__fixtures__/cjs/test.cjs");
    ...
    it(`should work as ESM package`, async () => {
        ...
        const filename = join(dirname(fileURLToPath(import.meta.url)), "../..", "__fixtures__/mjs/test.mjs");
