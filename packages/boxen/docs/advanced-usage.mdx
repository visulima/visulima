...
description: Master complex layouts, dynamic content, and advanced features
---
...
<Tabs items={['4 Spaces', '2 Spaces', 'Disabled']}>
  <Tab value="4 Spaces">
    ```typescript
...
<Callout type="warn">
Setting a fixed height will crop overflowing content. Use with caution.
</Callout>
...
<Callout type="info">
Building all boxes first and then displaying them at once is more efficient than rendering them one by one.
</Callout>
