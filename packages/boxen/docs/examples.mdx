---
title: Examples
description: Real-world examples and use cases for Boxen
---
...
```typescript
import { boxen } from "@visulima/boxen";
import { blue, green, dim, red } from "@visulima/colorize";
...
<Callout type="info">
All examples can be found in the [examples folder](https://github.com/visulima/visulima/tree/main/packages/boxen/examples) of the repository.
</Callout>
