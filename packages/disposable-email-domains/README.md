...
|------------|---------|---------|-------------|
| kslr/disposable-email-domains | 112.551 | ✅ | 0.27s (1.7 MB) |
| FGRibreau/mailchecker | 55.864 | ✅ | 0.30s (838.4 KB) |
| wesbos/burner-email-providers | 27.284 | ✅ | 0.24s (388.1 KB) |
| groundcat/disposable-email-domain-list | 27.120 | ✅ | 0.18s (401.7 KB) |
| disposable/disposable-email-domains | 26.697 | ✅ | 0.26s (375.5 KB) |
| sublime-security/static-files | 10.523 | ✅ | 0.18s (144.0 KB) |
| 7c/fakefilter | 8.975 | ✅ | 0.28s (128.9 KB) |
...
| unkn0w/disposable-email-domain-list | 3.617 | ✅ | 0.33s (45.8 KB) |
...
_Last updated: 2025-12-01T15:07:44.360Z_
