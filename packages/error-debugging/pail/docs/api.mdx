...
- `options?` - Configuration options (see [Configuration](/docs/packages/pail/configuration))
...
- `options?` - Configuration options (see [Object Tree Usage](/docs/packages/pail/usage/object-tree))
...
**See also:** [Object Tree Rendering](/docs/packages/pail/usage/object-tree) for detailed usage and examples.

## Related

- [Configuration](/docs/packages/pail/configuration) - Configuration guide
- [Examples](/docs/packages/pail/examples) - Usage examples
- [Object Tree Rendering](/docs/packages/pail/usage/object-tree) - Object tree utility
