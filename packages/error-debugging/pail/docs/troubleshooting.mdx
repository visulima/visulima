...
1. **Check the [API Reference](/docs/packages/pail/api)** for correct usage
2. **Review [Examples](/docs/packages/pail/examples)** for working code
...
- [Configuration](/docs/packages/pail/configuration) - Configuration options
- [API Reference](/docs/packages/pail/api) - Complete API documentation
