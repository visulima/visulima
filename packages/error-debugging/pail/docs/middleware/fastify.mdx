...
The Fastify adapter registers lifecycle hooks that attach a request-scoped [Wide Event](/docs/package/pail/usage/wide-events) to every request. The event auto-emits on response or error.
