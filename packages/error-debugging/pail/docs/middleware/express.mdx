...
The Express adapter attaches a request-scoped [Wide Event](/docs/package/pail/usage/wide-events) to every request. The event auto-emits when the response finishes.
