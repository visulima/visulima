...
Pail provides first-class middleware adapters for popular web frameworks. Each adapter automatically creates a request-scoped [Wide Event](/docs/package/pail/usage/wide-events) that:
...
- [Express](/docs/package/pail/middleware/express) — Express middleware guide
- [Fastify](/docs/package/pail/middleware/fastify) — Fastify plugin guide
- [Hono](/docs/package/pail/middleware/hono) — Hono middleware guide
- [Elysia](/docs/package/pail/middleware/elysia) — Elysia plugin guide
- [SvelteKit](/docs/package/pail/middleware/sveltekit) — SvelteKit hooks guide
- [Next.js](/docs/package/pail/middleware/nextjs) — Next.js integration guide
