...
The Hono adapter attaches a request-scoped [Wide Event](/docs/package/pail/usage/wide-events) to the Hono context. The event auto-emits when the handler completes or throws.
