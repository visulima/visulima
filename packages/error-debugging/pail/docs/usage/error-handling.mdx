...
- [Processors](/docs/package/pail/concepts/processors) - Process and enrich error metadata
- [API Reference](/docs/package/pail/api) - Complete PailError API
- [Examples](/docs/package/pail/examples) - Real-world error handling examples
