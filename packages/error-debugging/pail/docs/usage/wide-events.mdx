...
- [Express Middleware](/docs/package/pail/middleware/express) — Use wide events in Express apps
- [Fastify Plugin](/docs/package/pail/middleware/fastify) — Use wide events in Fastify apps
- [Hono Middleware](/docs/package/pail/middleware/hono) — Use wide events in Hono apps
- [Elysia Plugin](/docs/package/pail/middleware/elysia) — Use wide events in Elysia apps
- [SvelteKit Hooks](/docs/package/pail/middleware/sveltekit) — Use wide events in SvelteKit apps
- [Next.js Integration](/docs/package/pail/middleware/nextjs) — Use wide events in Next.js apps
