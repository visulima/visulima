...
function Home() {
    const throwError = () => {
        setTimeout(() => {
            ...
            const error = new Error("Example error from the TanStack Start + Cloudflare dev-toolbar demo");
    ...
    const rejectPromise = () => {
        void Promise.reject(new Error("Example unhandled rejection from the TanStack Start + Cloudflare dev-toolbar demo"));
    };

    return (
        <div className="p-8">
            <h1 className="mb-4 text-3xl font-bold">TanStack Start + Cloudflare + Dev Toolbar</h1>
            <p className="mb-6 text-gray-600 dark:text-gray-400">
                ...
                with SSR deployed on{" "}
                <a className="text-orange-500 underline" href="https://pages.cloudflare.com" rel="noreferrer" target="_blank">
                    Cloudflare Pages
                </a>{" "}
                and the Visulima Dev Toolbar.
            </p>
