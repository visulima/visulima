...
const { collectFiles, computeTaskHash, findAllCycles, findBackEdges, findCycle, getDependentTasks, getTransitiveDeps, hashCommand, hashEnvVar, hashFile, hashFilesBatch, hashFilesInDirectory, hashString, hashStrings, runConcurrent, runConcurrentBatch, topologicalSort } = nativeBinding
export { collectFiles }
