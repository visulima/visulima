...
| `--format gitlab`        | [GitLab dependency-scanning report](https://docs.gitlab.com/ee/development/integrations/secure.html) v15.2.1 — picked up by the Secure stage's Dependencies widget. |
