...
| ----------------------------- | --------------------------------------- | ------------------------------------------------------------------- |
| `applyDraft({ plan })`        | After versions + changelogs are written | Inspect the computed plan; throw to abort                           |
