...
const outdated: Command = {
    ...
    options: [
        ...
        { alias: "P", conflicts: "dev", description: "Production dependencies only (pnpm)", name: "prod", type: Boolean },
        { alias: "D", conflicts: "prod", description: "Dev dependencies only (pnpm)", name: "dev", type: Boolean },
