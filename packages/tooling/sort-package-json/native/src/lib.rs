...
pub fn sort_package_json_string_with_options(
    ...
    let opts = SortOptions {
        pretty: options.pretty.unwrap_or(true),
        sort_scripts: options.sort_scripts.unwrap_or(false),
    };
    sort_package_json_with_options(&contents, &opts)
