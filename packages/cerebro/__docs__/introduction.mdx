import { Play, Puzzle, Zap, Code } from "lucide-react";
import { Card, CardGroup, Tabs, Tab } from "@visulima/nextra-theme-docs/components";
...
<CardGroup cols={2}>
    ...
    <Card title="Toolbox" href="/docs/cerebro/toolbox/parameters" icon={<Code size={20} />}>
