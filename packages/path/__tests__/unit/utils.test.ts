...
import { filename, isAbsolute, isBinaryPath, isRelative, normalizeAliases, resolveAlias, reverseResolveAlias, toPath } from "../../src/utils";
...
describe("utils", () => {
    ...
    describe("isAbsolute", () => {
        ...
        describe("isAbsolute", () => {
            it("should return true for Unix-style absolute paths", () => {
                expect.assertions(1);
            ...
            it("should return true for paths with mixed slashes", () => {
                expect.assertions(1);
