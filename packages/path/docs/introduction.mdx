---
title: Introduction
description: Understanding the problem @visulima/path solves and why you should use it
---
...
<Callout type="warn" title="The Problem">
The native Node.js path module behaves differently on different operating systems, leading to inconsistent code behavior.
</Callout>
...
Ready to get started? Head over to the [Installation Guide](./installation) to add `@visulima/path` to your project.
