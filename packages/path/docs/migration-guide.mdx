...
description: Step-by-step guide to migrate from Node.js path module to @visulima/path
---
...
1. Check the [API Reference](./api-reference) for function compatibility
...
- Explore [Utility Functions](./utility-functions) for additional features
- Review [Best Practices](./getting-started#best-practices)
