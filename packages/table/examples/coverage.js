...
coverageTable.setHeaders(["Component", "Tests", "Tests", "Coverage"]);
coverageTable.addRow(["Frontend", "Unit", "156/156", "100%"]);
coverageTable.addRow(["", "Integration", "23/25", "92%"]);
coverageTable.addRow(["Backend", "Unit", "312/312", "100%"]);
coverageTable.addRow(["", "Integration", "45/60", "75%"]);
