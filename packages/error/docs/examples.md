...
- [Stack Trace Processing](#stack-trace-processing)
- [Pretty Error Rendering](#pretty-error-rendering)
- [Solution Finders](#solution-finders)
...
function formatStackForSlack(error: Error): string {
    ...
    for (const frame of frames.slice(0, 5)) {
        ...
        output += `• ${frame.methodName || "anonymous"} at ${location}\n`;
    }
