...
description: Serialize and deserialize errors for storage and transmission
---
...
<Callout type="error">
Standard `JSON.stringify()` on errors returns an empty object, losing all error information!
</Callout>
