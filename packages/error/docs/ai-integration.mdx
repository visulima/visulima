...
description: Use AI-powered error analysis and solution generation
---
...
<Callout type="info">
You'll need an API key from a supported AI provider (OpenAI, Anthropic, Google, Mistral, etc.).
</Callout>
...
```typescript title="Using AI to analyze errors"
