---
title: Code Frames
description: Generate and display code frames with error highlighting
---
...
<Callout>
Tabs in source code are automatically converted to spaces (default: 4 spaces). Set `tabWidth: false` to preserve tabs.
</Callout>
