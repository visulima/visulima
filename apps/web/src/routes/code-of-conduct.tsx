...
// Create a compiler instance for processing MDX content
const compiler = createCompiler({
    development: false,
});

// Server function to compile the markdown content
const loader = createServerFn({
    method: "GET",
}).handler(async () => {
    // Compile the markdown content on the server
...
// Component that renders the compiled content
