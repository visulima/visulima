...
<Cards>
    ...
    <Card title="Quick Start" href="/quick-start">Create your first table</Card>
    <Card title="Usage Guide" href="/usage">Explore all features</Card>
    <Card title="API Reference" href="/api">Complete API docs</Card>
</Cards>
