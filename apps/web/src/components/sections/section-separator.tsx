...
const SectionSeparator: FC<{ bgColor?: string; fillColor?: string; mode?: "light" | "dark"; position: "bottom" | "top" }> = ({
    ...
    >
        ...
        <div className="mx-auto flex w-full justify-between px-6 sm:max-w-[40rem] md:max-w-[48rem] md:px-8 lg:max-w-[64rem] xl:max-w-[80rem]">
            <svg aria-hidden="true" className={`mb-[calc(-1/16*1rem)] -ml-1.5 w-14 flex-none overflow-visible ${fillColor}`} viewBox="0 0 56 48">
                <path d="M 2.686 3 H -4 V 48 H 56 V 47 H 53.314 A 8 8 0 0 1 47.657 44.657 L 8.343 5.343 A 8 8 0 0 0 2.686 3 Z" />
            </svg>
            <svg aria-hidden="true" className={`${fillColor} -mr-1.5 mb-[calc(-1/16*1rem)] w-14 flex-none overflow-visible`} viewBox="0 0 56 48">
