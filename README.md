...
| [@visulima/tui-components](packages/terminal/tui-components/README.md) | [![npm](https://img.shields.io/npm/v/%40visulima%2Ftui-components?style=flat-square&labelColor=292a44&color=663399&label=v)](https://www.npmjs.com/package/%40visulima%2Ftui-components) | Component library for @visulima/tui — installable as a package, or copy-pasteable via the shadcn CLI registry |
